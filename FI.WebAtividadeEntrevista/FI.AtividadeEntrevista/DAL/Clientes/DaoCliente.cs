...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", cliente.CPF.SomenteNumeros()));
        ...
        internal bool VerificarExistencia(string CPF)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", CPF.SomenteNumeros()));
